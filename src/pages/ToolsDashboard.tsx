...
export default function ToolsDashboard() {
  ...
  const showToggleButtons = isSmallScreen && (
    location.pathname.startsWith('/video/text-to-video') ||
    location.pathname.startsWith('/video/ads') ||
    location.pathname.startsWith('/video/to-text') ||
    location.pathname.startsWith('/video/dubber') ||
    location.pathname.startsWith('/video/translator') ||
    location.pathname.startsWith('/video/subtitle-generator') ||
